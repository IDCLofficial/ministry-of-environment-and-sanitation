                                ...
                                <AnimatedEntrance {...ANIMATION_PRESETS.TEXT_FADE_LEFT} delay={200}>
                                    <div className="text-center md:text-left">
                                        <h2 className="text-lg sm:text-xl md:text-2xl font-bold mb-2 sm:mb-3 md:mb-4 leading-tight">
                                            Get Involved in Imo&apos;s Environmental Future
                                        </h2>
                                        <p className="max-w-lg opacity-70 text-sm sm:text-base leading-relaxed">
                                            Partner with us, join a program, or explore opportunities to create a cleaner, healthier environment with the Ministry of Environment and Sanitation.
                                        </p>
                                    </div>
                                </AnimatedEntrance>
                            ...
                            <div className="sm:col-span-2 md:col-span-1">
                                <Link href="/" className="group cursor-pointer">
                                    <div className="flex flex-col sm:flex-row items-start sm:items-center mb-4 sm:mb-6">
                                        ...
                                        <span className="text-base sm:text-lg md:text-xl font-bold flex-1 leading-tight transition-colors duration-300 group-hover:text-green-300">Ministry of Environment and Sanitation</span>
                                    </div>
                                </Link>
                                <p className="text-gray-300 leading-relaxed text-sm sm:text-base hover:text-gray-200 transition-colors duration-300">
                                    The Ministry of Environment and Sanitation leads Imo State&apos;s efforts in environmental protection, waste management, pollution control, and sustainable development through innovative policies and community engagement.
                                </p>
                            </div>
                        </AnimatedEntrance>
                        ...
                        <AnimatedEntrance {...ANIMATION_PRESETS.CARD_FADE_UP} delay={STAGGER_DELAYS.MEDIUM[3]}>
                            <div>
                                ...
                                <div className="mt-4 sm:mt-6 space-y-1 sm:space-y-2 text-xs sm:text-sm text-gray-300 grid">
                                    <a href="tel:+2348033372465" className="hover:text-green-300 transition-colors duration-300 cursor-pointer">+234 803 337 2465</a>
                                    <a href="mailto:info@environment.im.gov" className="hover:text-green-300 transition-colors duration-300 cursor-pointer">info@environment.im.gov</a>
